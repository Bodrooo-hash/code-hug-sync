            ...
            <div>
              {editingDescription ? (
                ...
                <button
                  ...
                  className="w-full rounded-xl border border-foreground/[0.06] bg-foreground/[0.03] px-2.5 py-1.5 text-left group/desc flex items-center gap-2 hover:border-foreground/[0.12] transition-colors"
                >
