              ...
              <div key={step.key} className="flex items-center flex-1 min-w-0">
                <button
                  ...
                  className={`flex items-center gap-0.5 px-1 py-1 rounded-lg transition-all w-full cursor-pointer hover:opacity-80 ${
                    isActive ? `${step.bg} ${step.color} ring-1.5 ring-inset ring-current` : isPassed ? 'bg-foreground/[0.04] text-foreground/30' : 'bg-transparent text-foreground/20 ring-1 ring-inset ring-foreground/10 hover:bg-foreground/[0.03]'
                  }`}
                >
